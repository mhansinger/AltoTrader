...
Have a look into the ``main.py``file, change for the correct asset pairs and adjust the window width in:

``XXBT_input = set_input(asset1='XXBT', asset2='ZEUR', long=100, short=47)``
Be sure to have somehow 'good' values for the windows, otherwise the trader will burn your coins easily. That's on your OWN RISK. 
